    ...
    <section>
      <div class="left">
        ...
        <ul class="nav">
          ...
          <li>
            <a href=""><i class="fa fa-calendar-days"></i>Appointments</a>
          </li>
        </ul>
      ...
      <div class="right-div">
        ...
        <div class="search-div">
            ...
            $sql = "SELECT user_id, name FROM users WHERE department='Xray'";
            ...
            if (mysqli_num_rows($result) > 0) {
              ...
              echo '<h3>No Xray Technicians Registered in the System</h3>';
            }
            ?>
