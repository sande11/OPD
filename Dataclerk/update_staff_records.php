          ...
          <div class="head">
            ...
            if (isset($_GET['patient_id'])) {
              ...
              if ($result->num_rows > 0) {
                ...
                echo '<input type="text" name="spouse_name" value="' . $row['spouse_name'] . '" required>';
                echo '</div>';

                echo '<div class="form-row">';
                echo '<label for="nationality"class="patient-form-label">Spouse Number:</label><br>';
                echo '<input type="text" name="spouse_number" value="' . $row['spouse_number'] . '" required>';
                echo '</div>';

                echo '<div class="form-row">';
                echo '<label for="nationality"class="patient-form-label">Spouse Email:</label><br>';
                echo '<input type="text" name="spouse_email" value="' . $row['spouse_email'] . '" required>';
                echo '</div>';

                echo '<div class="form-row">';
                echo '<label for="nationality" class="patient-form-label">Spouse Physical Address:</label><br>';
                echo '<input type="text" name="spouse_physical_address" value="' . $row['spouse_physical_address'] . '" required>';
                echo '</div>';
