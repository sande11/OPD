  ...
  <div class="overlay">
    ...
    <section>
      <div class="left">
        ...
        <ul class="nav">
          <li>
            <a href="../Dataclerk/home.php"><i class="fa fa-th-large"></i> Home</a>
          </li>
          <li>
            <a href="../Dataclerk/dataclerk.php"><i class="fa-solid fa-hospital-user"></i>Register Patient</a>
          </li>
          <li>
            <a href="../Dataclerk/OPR.php"><i class="fa fa-book"></i> OPR</a>
          </li>
          <li>
            <a href="../Dataclerk/staff.php"><i class="fa fa-user-doctor"></i>Register Staff</a>
          </li>
          <li>
        ...
        <select name="test_date" id="test_date" style="padding:6px; background-color:#f0a732;" onchange="document.getElementById('lab_status_form').submit()">
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                $eventsHtml .= '<li>Title: ' . $row["title"] . ' <br>Patient Name: ' . $row["patientName"] . ' <br>Subject: ' . $row["subject"] . ' </li>';
              }
