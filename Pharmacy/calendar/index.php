        ...
        $(document).ready(function() {
            var calendar = $('#calendar').fullCalendar({
                ...
                select: function(start, end, allDay) {
                    ...
                    var medication_name = prompt('Medication Name:');
                    var dosage = prompt('Dosage:');
                    var contact_info = prompt('Patient Phone Number:');
                    var subject = "<?php echo $departmentName; ?>";
                    ...
                    if (title) {
                        ...
                        $.ajax({
                            url: 'add-event.php',
                            data: 'title=' + title + '&start=' + start + '&end=' + end + '&subject=' + subject + '&patientName=' + patientName + '&details=' + details + '&medication_name=' + medication_name + '&dosage=' + dosage + '&contact_info=' + contact_info,
                            type: "POST",
    ...
    <div class="overlay">
        ...
        <section>
            <div class="left">
                ...
                <ul class="nav">
                    <li>
                        <a href="\265 OPD\pharmacy\pharmacy dashboard.php"><i class="fa-solid fa-caret-left"></i>Pharmacy</a>
                    </li>
         ...
         -->
            ...
            <div class="right-div">
                <div id="main">
                    ...
                    <div class="head">
                        <div class="col-1">
                            <p class="nav-title">Medication Schedule</p>
        ...
        <form method="post" action="" id="lab_status_form">
            ...
            <select name="test_date" id="test_date" style="padding:6px; background-color:#f0a732;" onchange="document.getElementById('lab_status_form').submit()">
                ...
                <option value="All Tests">All Tests</option>
                        ...
                        $sql = "SELECT * FROM appointments WHERE DATE(start) = '$currentDate' AND subject = '" . $_SESSION['department'] . "'";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                $eventsHtml .= '<li>Title: ' . $row["title"] . ' <br>Patient Name: ' . $row["patientName"] . ' <br>Details: ' . $row["details"] . ' <br>Medication Name: ' . $row["medication_name"] . ' <br>Dosage: ' . $row["dosage"] . ' <br>Contact Info: ' . $row["contact_info"] . '</li>';
                            }
