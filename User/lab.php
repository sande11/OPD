        ...
        <section>
            ...
            <div class="left">
                ...
                <ul class="nav">
                    ...
                    <li><a href="lab.html"><i class="fa-solid fa-microscope"></i> Laboratory</a></li>
                    <li><a href="xray.html"><i class="fa-solid fa-x-ray"></i> X-Ray</a></li>
                </ul>
                <br><br>
                <div class="fill">
                ...
                <div id="main">
                    ...
                    <div class="head">
                        ...
                        <div class="patient-block">
                            ...
                            <button class="view">View Patient</button>
                        </div>
