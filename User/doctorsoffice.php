    ...
    <div class="overlay">
        ...
        <section>
            ...
            <div class="left">
                ...
                <!-- nav -->
                <ul class="nav">
                    <li><a href="Dashboard.php"><i class="fa fa-th-large"></i> Home</a></li>
                    <!-- <li><a href="patients.php"><i class="fa fa-user"></i> Patients</a></li> -->
                ...
                <br><br>
                <div class="fill" style="margin-top: 50px;">
            ...
            <div class="right-div">
                <div id="main">
                    ...
                    <div class="head">
                        ...
                        $sql = "SELECT * FROM tests WHERE test_name != 'Consultation'";
                        ...
                        if (isset($_SESSION['selectedRoom'])) {
                            ...
                            if (mysqli_num_rows($resultPatients) > 0) {
                                while ($row = mysqli_fetch_assoc($resultPatients)) {
                                    ...
                                    echo '</div>';
                                    // test orders
                                    echo '<div class="form-popup" id="testsForm" style="display:none; margin-top:-100px;">';
                                    echo '<form action="testorders.php" class="form-container" method="POST">';
                                    echo '<h2><b>Available Tests</b></h2>';
                                    if (mysqli_num_rows($testresult) > 0) {
                                        while ($test = mysqli_fetch_assoc($testresult)) {
                                            echo '<p>' . $test['test_name'] . '</p>';
                                        }
                                    } else {
                                        echo '<p>No tests available at the moment.</p>';
                                    }
                                    echo '<h2>Order Test</h2>';
...
<div class="form-popup" id="myForm" style="display:none;">
    <form action="diagnosissubmission.php" class="form-container" method="POST" style="width: 800px;">
        <h1>Diagnosis</h1>
        <input type="hidden" name="patient_id" value="{$row['patient_id']}">
        <label for="email"><b>Diagnosis</b></label>
        <input type="text" placeholder="Enter patient's diagnosis" name="diagnosis" required>
        <label><b>Prescription</b></label>
        <input type="text" id="drugFilter" placeholder="Search drugs">
...
HTML;
                                    ...
                                    if (mysqli_num_rows($result_drugs) > 0) {
                                        ...
                                        while ($drug_row = mysqli_fetch_assoc($result_drugs)) {
                                            ...
                                            echo '<br>';
                                            echo ' Quantity or Dose duration: <input type="text" name="quantity[' . $index . ']" placeholder="Quantity or dose duration">';
                                            echo '</label>';
                                            $index++;
                                            // Add the medication ID to the prescription array if it is selected
                                            if (isset($_POST['prescription']) && in_array($drug_row['medication_name'], $_POST['prescription'])) {
                                                $quantity[] = $_POST['quantity'][$index]; // Assuming $index is a counter incremented within the loop
                                            }
                                        }
